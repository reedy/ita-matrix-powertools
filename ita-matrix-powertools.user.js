...
var userSettings = __webpack_require__("./src/settings/userSettings.js");
// EXTERNAL MODULE: ./src/settings/appSettings.ts
var appSettings = __webpack_require__("./src/settings/appSettings.ts");
// EXTERNAL MODULE: ./src/state/index.ts + 1 modules
var state = __webpack_require__("./src/state/index.ts");
;// CONCATENATED MODULE: ./src/print/history.tsx
...
function renderHistoryContainer() {
    const container = (dom_chef.createElement("div", { style: {
            position: "fixed",
            width: "200px",
            top: "20px",
            left: 0,
...
async function redrawHistory(setting) {
    ...
    if (!div) {
        div = dom_chef.createElement("div", { id: id });
        container.appendChild(div);
    }
    div.innerHTML = null;
    if (!userSettings.default[setting] || !userSettings.default[setting].length)
        return;
    div.appendChild(dom_chef.createElement("p", null, section.title));
    let lastDistance;
    await userSettings.default[setting].reduce(async (last, h) => {
        ...
        div.appendChild(dom_chef.createElement("div", { class: "pt-history-item", style: {
                position: "relative",
                margin: "1em -1rem",
                padding: "0 1rem"
            } },
            dom_chef.createElement("a", { style: {
                    display: "block"
                }, onClick: e => changeSearch(e, search[1], h.savedSearch), href: h.url, title: linkText }, linkText),
            section.showPin ? (dom_chef.createElement("a", { class: "pt-history-action", style: {
                    cursor: "pointer",
                    position: "absolute",
                    left: 0,
                    top: 0,
            ...
            dom_chef.createElement("a", { class: "pt-history-action", style: {
                ...
                dom_chef.createElement("svg", { style: { width: ".8rem", height: ".8rem", fill: "red" }, xmlns: "http://www.w3.org/2000/svg", height: "512pt", width: "512pt", viewBox: "0 0 512 512" },
                    dom_chef.createElement("path", { d: "M256 512C114.836 512 0 397.164 0 256S114.836 0 256 0s256 114.836 256 256-114.836 256-256 256zm0-480C132.48 32 32 132.48 32 256s100.48 224 224 224 224-100.48 224-224S379.52 32 256 32zm-79.187 319.188c-4.098 0-8.195-1.555-11.309-4.691-6.25-6.25-6.25-16.383 0-22.633l158.398-158.402c6.254-6.25 16.387-6.25 22.637 0s6.25 16.383 0 22.637L188.137 346.496c-3.156 3.137-7.25 4.691-11.324 4.691zm0 0" }),
                    dom_chef.createElement("path", { d: "M335.188 351.188c-4.094 0-8.191-1.555-11.305-4.691L165.484 188.117a16 16 0 1 1 22.633-22.633l158.398 158.398a16 16 0 0 1 0 22.633c-3.133 3.117-7.23 4.672-11.328 4.672zm0 0" })))));
        function pin(search) {
...
/* harmony export */ });
/* harmony import */ var _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/settings/userSettings.js");
/* harmony import */ var _settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/settings/itaSettings.js");
/* harmony import */ var _settings_translations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/settings/translations.js");
/* harmony import */ var _parse_itin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/parse/itin.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/utils.js");
/* harmony import */ var _links__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/print/links.js");
...
function render() {
    ...
    if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.enableEditormode == 1 &&
        ...
        removeEditor();
        (0,_parse_itin__WEBPACK_IMPORTED_MODULE_3__.readItinerary)();
    }
    bindPageLayout();
...
function addEditor() {
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin.length; i++) {
        for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg.length; j++) {
...
function removeEditor() {
    for (let i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin.length; i++) {
        for (let j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg.length; j++) {
...
function bind24HourTime() {
    ...
    const segs = (0,_parse_itin__WEBPACK_IMPORTED_MODULE_3__.getCurrentSegs)();
    if (segs.length > 0) {
        ...
        do {
            ...
            if (type == 1) {
                ...
                if ((0,_utils__WEBPACK_IMPORTED_MODULE_5__.hasClass)(target.nextElementSibling, _settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__.default.resultpage.htbGreyBorder)) {
                    ...
                    if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.enableInlineMode == 1) {
                        ...
                        output +=
                            "<tr><td>" +
                                ...
                                (sum / _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.dist / 100).toFixed(4).toString() +
                                "</td></tr>";
                        output +=
                    ...
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.basefares = +basefares.toFixed(2);
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.taxes = +taxes.toFixed(2);
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.surcharges = +surcharges.toFixed(2);
                    // reset var
                    basefound = 0;
                    basefares = 0;
                    taxes = 0;
...
function printCPM() {
    document
        ...
        .insertAdjacentHTML("beforeend", `<li class="powertoolsitem">${(Number(_parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.price) / Number(_parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.dist)).toFixed(4)} cpm</li>`);
}
function bindSeatguru() {
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin.length; i++) {
        ...
        for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg.length; j++) {
            ...
            while (j + k < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg.length - 1) {
                if (_parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j + k].fnr !=
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j + k + 1].fnr ||
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j + k].layoverduration >= 1440)
                    break;
                k++;
            }
            ...
            if (!target) {
                ...
                var url = "http://www.seatguru.com/findseatmap/findseatmap.php?carrier=" +
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].carrier +
                    "&flightno=" +
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].fnr +
                    "&date=" +
                    ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].dep.month).slice(-2) +
                    "%2F" +
                    ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].dep.day).slice(-2) +
                    "%2F" +
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].dep.year +
                    "&to=&from=" +
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].orig;
        ...
        for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg.length; j++) {
            ...
            if (!target) {
                ...
                var url = "http://www.wheretocredit.com/" +
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].carrier.toLowerCase() +
                    "/" +
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].bookingclass.toLowerCase();
                target.children[0].classList.add("pt-textlink");
                target.children[0].innerHTML = target.children[0].innerHTML
                    .replace(/<a.*?\/a>/, "(" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].bookingclass + ")")
                    .replace("(" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].bookingclass + ")", '<a href="' +
                    url +
                    '" target="_blank">(' +
                    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].bookingclass +
                    ")</a>");
            }
        }
    }
...
/* harmony export */ });
/* harmony import */ var _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/settings/appSettings.ts");
/* harmony import */ var _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/settings/userSettings.js");
/* harmony import */ var _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/settings/paxSettings.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/utils.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/print/index.ts");
/* harmony import */ var _links__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/print/links.js");
...
function createUsersettings() {
    ...
    document.getElementById("settingsVisToggler").onclick = function () {
        (0,_utils__WEBPACK_IMPORTED_MODULE_5__.toggleVis)(document.getElementById("mptSettings"));
    };
    document.getElementById("passengerVisToggler").onclick = function () {
        (0,_utils__WEBPACK_IMPORTED_MODULE_5__.toggleVis)(document.getElementById("mptPassengers"));
    };
    // Build settings
    ...
    Object.keys(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings).forEach(setting => {
        str += `<div id="mpt${setting}" style="width:33%;float:left;">${_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings[setting].name}: <label style="cursor:pointer;">${printSettingsvalue(setting)}</label></div>`;
    });
    ...
    document.getElementById("mptStartparse").onclick = function () {
        setTimeout(function () {
            (0,___WEBPACK_IMPORTED_MODULE_3__.render)();
        }, 50);
    };
    Object.keys(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings).forEach(setting => {
    ...
    if (window.confirm("Are you sure you want to reset any saved settings to the default values? The page will automatically reload to complete the reset.")) {
        (async () => {
            if (typeof GM === "undefined" || typeof GM.info != "undefined") {
                await (0,_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.saveUserSettings)(null);
            }
...
function toggleSettings(target) {
    ...
    if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings[target] && _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings[target].values) {
        const pos = findPositionForValue(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default[target], _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings[target].values);
        if (pos >= _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings[target].values.length - 1 || pos === -1) {
            _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default[target] = _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings[target].values[0].value;
        }
        else {
            _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default[target] =
                _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings[target].values[pos + 1].value;
        }
    }
    else {
        switch (target) {
            case "timeformat":
                if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.timeformat == "12h") {
                    _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.timeformat = "24h";
                }
                else {
                    _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.timeformat = "12h";
                }
                break;
            case "language":
                if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.language == "de") {
                    _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.language = "en";
                }
                else {
                ...
                break;
            case "linkFontsize":
                if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.linkFontsize <= 190 &&
                    _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.linkFontsize >= 50) {
                    _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.linkFontsize += 10;
                }
                else {
                    _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.linkFontsize = 50;
                }
            ...
            case "cabin":
                ...
                break;
            default:
                if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default[target] == 1) {
                    _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default[target] = 0;
                }
                else {
                    _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default[target] = 1;
                }
        }
    }
    document.getElementById("mpt" + target).firstElementChild.innerHTML = printSettingsvalue(target);
    (0,_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.saveUserSettings)();
}
function processPassengers() {
    let e = document.getElementById("numAdults");
    _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.adults = Number(e.options[e.selectedIndex].value);
    e = document.getElementById("numInfantsLap");
    _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.infantsLap = Number(e.options[e.selectedIndex].value);
    e = document.getElementById("numInfantsSeat");
    _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.infantsSeat = Number(e.options[e.selectedIndex].value);
    _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.cAges = new Array();
    for (let i = 1; i <= 8; i++) {
        processChild("child" + i + "age");
    }
    const paxText = _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.adults +
        "a" +
        (_settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.cAges.length > 0
            ? " " + _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.cAges.length + "c"
            : "") +
        (_settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.infantsLap + _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.infantsSeat > 0
            ? " " +
                (_settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.infantsLap + _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.infantsSeat) +
                "i"
            : "");
...
function processChild(target) {
    ...
    if (tmp >= 2) {
        _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__.default.cAges.push(tmp);
    }
}
function printSettingsvalue(target) {
    if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings[target]) {
        return findNameForValue(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default[target], _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.registeredSettings[target].values);
    }
    switch (target) {
        case "timeformat":
            return _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.timeformat;
        case "language":
            return _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.language;
        case "linkFontsize":
            return _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default.linkFontsize.toString();
        case "cabin":
            return _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__.default.cabin;
        default:
            return boolToEnabled(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__.default[target]);
    }
}
...
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/utils.js");
/* harmony import */ var _print_settings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/print/settings.ts");
/* harmony import */ var _print_history__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/print/history.tsx");
...
/***/ "./src/links/airlines/aa.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/settings/userSettings.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/utils.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/links/index.js");
/* harmony import */ var _parse_itin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/parse/itin.js");
...
function printAA() {
  ...
  var createUrl = function(edition) {
    ...
    var search = "1,,USD0.00," + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.length + ",";
    var legs = new Array();
    var leg = "";
    var segs = new Array();
    var seg = "";
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.length; i++) {
      // walks each leg
      segs = new Array();
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg.length; j++) {
        //walks each segment of leg
        var k = 0;
        // lets have a look if we need to skip segments - Flightnumber has to be the same and it must be just a layover
        while (j + k < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg.length - 1) {
          if (
            _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k].fnr !=
              _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k + 1].fnr ||
            _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k].layoverduration >= 1440
          )
            break;
          k++;
        }
        seg =
          _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k].arr.year +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k].arr.month).slice(-2) +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k].arr.day).slice(-2) +
          "T" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k].arr.time).slice(-5) +
          (typeof _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k].arr.offset == "undefined"
            ? "+00:00"
            : _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k].arr.offset) +
          ",";
        seg += _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].bookingclass + ",";
        seg +=
          _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.year +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.month).slice(-2) +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.day).slice(-2) +
          "T" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.time).slice(-5) +
          (typeof _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.offset == "undefined"
            ? "+00:00"
            : _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.offset) +
          ",";
        seg += _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k].dest + ",";
        seg +=
          _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].carrier +
          _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].fnr +
          ",";
        seg += _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].orig; // NO , here!
        segs.push(seg);
        j += k;
      }
      ...
      //build leg structure
      leg =
        _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].dep.year +
        "-" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].dep.month).slice(-2) +
        "-" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].dep.day).slice(-2) +
        ",";
      leg += _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].dest + ",,";
      leg += _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].orig + ","; // USE , here!
      legs.push(leg);
    }
    search += "DIRECT,";
    ...
    // push outer search
    search += _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.length + "," + legs.join();
...
var links = __webpack_require__("./src/links/index.js");
// EXTERNAL MODULE: ./src/parse/itin.js
var itin = __webpack_require__("./src/parse/itin.js");
// EXTERNAL MODULE: ./node_modules/date-fns/esm/_lib/cloneObject/index.js + 1 modules
var cloneObject = __webpack_require__("./node_modules/date-fns/esm/_lib/cloneObject/index.js");
// EXTERNAL MODULE: ./node_modules/date-fns/esm/toDate/index.js
var toDate = __webpack_require__("./node_modules/date-fns/esm/toDate/index.js");
...
;// CONCATENATED MODULE: ./src/json/timezones.json
...
/* harmony import */ var _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/settings/userSettings.js");
/* harmony import */ var _settings_translations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/settings/translations.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./src/utils.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/links/index.js");
/* harmony import */ var _parse_itin__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/parse/itin.js");
/* harmony import */ var _print_amadeus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/print/amadeus.js");
...
function printAC() {
  ...
  var createUrl = function(edition) {
    ...
    if (!pax) {
      (0,_utils__WEBPACK_IMPORTED_MODULE_6__.printNotification)("Error: Failed to validate Passengers in printAC");
      return;
    }
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_4__.currentItin.itin.length; i++) {
      acUrl +=
        "&departure" +
        (i + 1) +
        "=" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__.currentItin.itin[i].dep.day).slice(-2) +
        "/" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__.currentItin.itin[i].dep.month).slice(-2) +
        "/" +
        _parse_itin__WEBPACK_IMPORTED_MODULE_4__.currentItin.itin[i].dep.year +
        "&org" +
        (i + 1) +
        "=" +
        _parse_itin__WEBPACK_IMPORTED_MODULE_4__.currentItin.itin[i].orig +
        "&dest" +
        (i + 1) +
        "=" +
        _parse_itin__WEBPACK_IMPORTED_MODULE_4__.currentItin.itin[i].dest;
    }
...
/* harmony import */ var _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/settings/appSettings.ts");
/* harmony import */ var _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/settings/userSettings.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/utils.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/links/index.js");
/* harmony import */ var _parse_itin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/parse/itin.js");
...
/***/ "./src/links/airlines/as.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/utils.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/links/index.js");
/* harmony import */ var _parse_itin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/parse/itin.js");
...
function printAS() {
  ...
  var createUrl = function() {
    ...
    url += (0,_parse_itin__WEBPACK_IMPORTED_MODULE_1__.isOneway)() ? "ow" : "rt";

    var k = 0;
    //Build multi-city search based on legs
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length; i++) {
      // walks each leg
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg.length; j++) {
        //walks each segment of leg
        var itinseg =
          _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].orig +
          "|" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dest;
        itinseg +=
          "|" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.month).slice(-2) +
          "/" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.day).slice(-2);
        itinseg += "/" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.year;
        itinseg += "|" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].fnr + "|";
        itinseg += _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].cabin ? "f" : "c";
        url += "&F" + ++k + "=" + encodeURIComponent(itinseg);
      }
    }
    url +=
      "&DEST=" +
      _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[0].seg[_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[0].seg.length - 1].dest;
    url += "&FARE=" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.price + "&frm=cart&META=GOO_CS";
    return url;
  };
  var url = createUrl();
  if (!url) {
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.length; i++) {
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg.length; j++) {
        azUrl +=
          ...
          seg +
          "].From=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].orig;
        azUrl +=
          "&MetaSearchDestinations[" +
          seg +
          "].To=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dest;
        azUrl +=
          "&MetaSearchDestinations[" +
          seg +
          "].DepartureDate=" +
        ...
        azUrl +=
          ...
          seg +
          "].ArrivalDate=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].arr.year +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].arr.month).slice(-2) +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].arr.day).slice(-2) +
          ":" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].arr.time).slice(-5);
        azUrl +=
          "&MetaSearchDestinations[" +
          seg +
          "].Flight=" +
        ...
        azUrl +=
          ...
          seg +
          "].code=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].farebase;
        azUrl += "&MetaSearchDestinations[" + seg + "].MseType=";
        azUrl +=
          "&MetaSearchDestinations[" +
          seg +
          "].bookingClass=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].bookingclass;
        azUrl +=
          "&MetaSearchDestinations[" +
          seg +
          "].cabinClass=" +
          cabins[_parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].cabin];
  ...
  var createUrl = function(edition, language) {
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin.length; i++) {
      ...
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg.length; j++) {
        ...
        while (j + k < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg.length - 1) {
          if (
            _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j + k].fnr !=
              _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j + k + 1].fnr ||
            _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j + k].layoverduration >= 1440
          )
            break;
        ...
        url +=
          ...
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].dep.month).slice(-2) +
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].dep.year +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].dep.time.replace(":", "")).slice(
            -4
          );
        url +=
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].carrier +
          ("000" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].fnr).slice(-4);
        url += cabins[_parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].cabin];
        url +=
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].orig + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j + k].dest;
        if (_parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin.length == 2 && i == 1) {
          url += "F";
        } else {
          url += "T";
        }
        if (_parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].cabin < mincabin) {
          mincabin = _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].cabin;
        }
        j += k;
      }
    }
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/utils.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/links/index.js");
/* harmony import */ var _print_amadeus__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/print/amadeus.js");
...
function printDL() {
  ...
  var createUrl = function(edition) {
    ...
    url += "&price=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.price;
    url += "&currencyCd=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.cur;
    url += "&exitCountry=" + edition[1].toUpperCase();

    const fares = [];

    let segnum = 0;
    _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.forEach((itin, legnum) => {
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/links/index.js");
/* harmony import */ var _parse_itin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/parse/itin.js");
/* harmony import */ var _settings_appSettings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/settings/appSettings.ts");
...
function print() {
  ...
  const createUrl = function(edition) {
    let url = `https://www.emirates.com/sessionhandler.aspx?pageurl=/IBE.aspx&pub=${edition}&j=f&section=IBE&j=t&seldcity1=${
      _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[0].orig
    }&selacity1=${_parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[0].dest}&selddate1=${formatDate(
      _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[0].dep
    )}&seladults=${pax.adults}&selofw=0&selteenager=0&selchildren=${
      pax.children.length
    }&selinfants=${pax.infLap}&selcabinclass=${
      cabins[(0,_settings_appSettings__WEBPACK_IMPORTED_MODULE_3__.getCabin)(Math.max(...(0,_parse_itin__WEBPACK_IMPORTED_MODULE_2__.getCurrentSegs)().map(seg => seg.cabin)))]
    }&selcabinclass1=${
      cabins[
        (0,_settings_appSettings__WEBPACK_IMPORTED_MODULE_3__.getCabin)(Math.max(..._parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[0].seg.map(seg => seg.cabin)))
      ]
    }&showsearch=false&showTeenager=false&showOFW=false&chkFlexibleDates=false&resultby=0&multiCity=`;
    if ((0,_parse_itin__WEBPACK_IMPORTED_MODULE_2__.isOneway)()) {
      url += `&seladate1=&TID=OW`;
    } else if ((0,_parse_itin__WEBPACK_IMPORTED_MODULE_2__.isRoundtrip)()) {
      url += `&seladate1=${formatDate(_parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[1].dep)}&TID=SB`;
    } else {
      ...
      url =
        ...
        _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.map(
            itin =>
...
/***/ "./src/links/airlines/ey.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/utils.js");
/* harmony import */ var _print_links__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/print/links.js");
/* harmony import */ var _parse_itin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/parse/itin.js");
/* harmony import */ var _settings_appSettings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/settings/appSettings.ts");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/links/index.js");
...
function printEY() {
  ...
  var createUrl = function() {
    ...
    let url =
      ...
      (0,_parse_itin__WEBPACK_IMPORTED_MODULE_1__.getTripType)("OW", "RT", "MC");
    url += `&numAdults=${pax.adults}`;
    url += `&numChildren=${pax.children.length}`;
    url += `&numInfants=${pax.infLap}`;
    url += `&advertisedFare=${_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.price}`;
    url += `&currency=${_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.cur || "USD"}`;

    let segnum = 0;
    _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.forEach((itin, legnum) => {
      itin.seg.forEach(seg => {
...
function printIB() {
  ...
  var createUrl = function(edition, currency) {
    ...
    var url =
      ...
      edition[0] +
      "&TripType=" +
      (0,_parse_itin__WEBPACK_IMPORTED_MODULE_2__.getTripType)("OneWay", "RoundTrip", "MultiCity");
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.length; i++) {
      ...
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg.length; j++) {
        ...
        url += "&Origin" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].orig;
        url += "&Destination" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j + k].dest;
        url += "&Carrier" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].carrier;
        url +=
          "&DepartureDate" +
          seg +
          "=" +
          ...
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.day).slice(-2);
        url += "&FlightNumber" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].fnr;
        url +=
          "&BookingCode" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].bookingclass;
        url += "&Cabin" + seg + "=" + cabins[_parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].cabin];
  ...
  var createUrl = function(edition) {
    ...
    url +=
      ...
      segs
        ...
        .join("-");
    url += "&ref=MS,fb=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.farebases.join(".");
...
function printLA() {
  ...
  var createUrl = function(edition) {
    ...
    const parameters = {
      ...
      trip: {
        flights: _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.map(itin => {
          return {
            amount: _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.price,
            currency: _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.cur || "USD",
...
function printLX() {
  ...
  var createUrl = function(edition) {
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin.length; i++) {
      // walks each leg
      url +=
        "/" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].orig + "-" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].dest + "/";
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg.length; j++) {
        //walks each segment of leg
        var k = 0;
        // lets have a look if we need to skip segments - Flightnumber has to be the same and it must be just a layover
      ...
      url +=
        ...
        (i > 0 ? "to" : "from") +
        "-" +
        _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].dep.year +
        "-" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].dep.month).slice(-2) +
        "-" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].dep.day).slice(-2);
    }
    url +=
      "/adults-" +
      pax.adults +
...
function print() {
  ...
  const createUrl = function(edition) {
    ...
    const carriers = {};
    const farebases = [];
    _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.forEach((itin, itinnum) => {
      ...
      itin.seg.forEach((seg, segnum) => {
        ...
        farebases.push(_parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.farebases[itinnum]);
      });
    });
...
function printPS() {
  ...
  var createUrl = function(edition, currency) {
    ...
    var url =
      ...
      edition[0] +
      "&TripType=" +
      (0,_parse_itin__WEBPACK_IMPORTED_MODULE_1__.getTripType)("OneWay", "RoundTrip", "MultiCity");
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length; i++) {
      ...
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg.length; j++) {
        ...
        var k = 0;
        // lets have a look if we need to skip segments - Flightnumber has to be the same and it must be just a layover
        while (j + k < _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg.length - 1) {
          if (
            _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].fnr !=
              _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k + 1].fnr ||
            _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].layoverduration >= 1440
          )
            break;
          k++;
        }
        url += "&Origin" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].orig;
        url += "&Destination" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].dest;
        url += "&Carrier" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].carrier;
        url +=
          "&DepartureDate" +
          seg +
          "=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.year +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.month).slice(-2) +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.day).slice(-2);
        url += "&FlightNumber" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].fnr;
        url +=
          "&BookingCode" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].bookingclass;
        url += "&Cabin" + seg + "=" + cabins[_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].cabin];
        slicestr += (slicestr === "" ? "" : "%2C") + seg;
        j += k;
      }
      url += "&Slice" + slice + "=" + slicestr;
...
function printQF() {
  ...
  var createUrl = function(edition, currency) {
    ...
    var tmpTravelDates = "";
    var finalDest = _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[0].seg[0].dest;
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin.length; i++) {
      ...
      if (tmpTravelDates === "" || !tmpTravelDates) {
        tmpTravelDates +=
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].dep.year.toString() +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].dep.month).slice(-2).toString() +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].dep.day).slice(-2).toString() +
          "0000";
      } else {
        tmpTravelDates +=
          "%2C" +
      ...
      segDepAirports += _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].orig.toString();
      // Grab the destination airport of each leg:
      if (segDestAirports.length > 14) segDestAirports += "%2C";
      segDestAirports += _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].dest.toString();
      ...
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg.length; j++) {
        ...
        depAirports += _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].orig.toString();
        // all destination airports:
        if (destAirports.length > 14) destAirports += "%2C";
        destAirports += _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin[i].seg[j].dest.toString();
...
function print() {
  ...
  const cabin =
    cabins[(0,_settings_appSettings__WEBPACK_IMPORTED_MODULE_2__.getCabin)(Math.min(...(0,_parse_itin__WEBPACK_IMPORTED_MODULE_1__.getCurrentSegs)().map(seg => seg.cabin)))];

  const tripType = _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length > 1 ? "M" : "O";
  ...
  url += _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.map((itin, i) => {
    ...
    .join("&");
  if (_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length <= 2) url += "&price=0";
  return {
    url,
    title: "Qatar Airways"
  };
...
function printTK() {
  if (!(0,___WEBPACK_IMPORTED_MODULE_1__.anyCarriers)("TK")) {
    return;
  }
  ...
  if (!pax) {
    (0,_utils__WEBPACK_IMPORTED_MODULE_3__.printNotification)("Error: Failed to validate Passengers in printTK");
    return;
  }
  var amadeusConfig = {
    sepcabin: 0,
  ...
  url +=
    "&LANGUAGE=" +
    (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.language == "tk" || _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.language == "de"
      ? _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.language.toUpperCase()
      : "GB");
...
(0,___WEBPACK_IMPORTED_MODULE_1__.register)("airlines", printTK);


/***/ }),

/***/ "./src/links/airlines/vs.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function printVS() {
  ...
  var createUrl = function() {
    ...
    url += `&exitCountry=US`;
    url += `&currencyCd=${_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.cur || "USD"}`;
...
/* harmony export */ });
/* harmony import */ var _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/settings/userSettings.js");
/* harmony import */ var _settings_paxSettings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/settings/paxSettings.js");
/* harmony import */ var _print_links__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/print/links.js");
/* harmony import */ var _parse_itin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/parse/itin.js");
...
const req = __webpack_require__("./src/links sync recursive .[jt]s$");
...
function allCarriers() {
  ...
  return (
    ...
    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.carriers.every(cxr => args.some(arg => cxr === arg))
  );
}
...
function anyCarriers() {
  ...
  return (
    _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.showAllAirlines ||
    _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.carriers.some(cxr => args.some(arg => cxr === arg))
  );
}
...
/***/ "./src/links/meta/googleFlights.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function print() {
  ...
  const url =
    ...
    _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.map(
        itin =>
      ...
      .join("*") +
    `;c:${_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.cur || "USD"};px:${pax.adults},${pax.children.length},${
      pax.infLap
    },${pax.infSeat};sc:${cabin};tt:${
      _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length === 1 ? "o" : "m"
    }`;
...
function print() {
  if ((0,_parse_itin__WEBPACK_IMPORTED_MODULE_1__.isMulticity)()) return; // no multi segments
  ...
  var createUrl = function(host) {
    return `${host}?adults=${pax.adults}&children=${
      pax.children.length
    }&infants=${pax.infLap}&cabin_class=${cabin}&${_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.map(
        (seg, i) =>
...
function print(method) {
  ...
  const segs = !method ? _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin : (0,_parse_itin__WEBPACK_IMPORTED_MODULE_3__.getCurrentSegs)();
  if (method && _parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.itin.length === segs.length) return;
  ...
  const cabin =
    cabins[(0,_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__.getCabin)(Math.min(...(0,_parse_itin__WEBPACK_IMPORTED_MODULE_3__.getCurrentSegs)().map(seg => seg.cabin)))];
  ...
  const createUrl = function(host) {
    ...
    if (pax.adults > 1 || pax.children.length || pax.infSeat || pax.infLap) {
      url += `/${_parse_itin__WEBPACK_IMPORTED_MODULE_3__.currentItin.numPax}adults`;
    }
...
function printCheapOair() {
  ...
  coaUrl +=
    ...
    pax.infLap;
  coaUrl += "&pos=US";
  coaUrl += "&dispr=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.price;
  var seg = 0;
  var slices = {};
  for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.length; i++) {
    slices[i] = "";
    for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg.length; j++) {
      ...
      coaUrl +=
        ...
        cabins[
          _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__.default.cabin === "Auto"
            ? _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].cabin
            : (0,_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__.getForcedCabin)()
        ];
      coaUrl += "&carr" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].carrier;
      coaUrl +=
        "&dd" +
        seg +
        "=" +
        ...
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.month).slice(-2) +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.day).slice(-2);
      coaUrl += "&og" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].orig;
      coaUrl += "&dt" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dest;
      coaUrl += "&fbc" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].bookingclass;
      coaUrl += "&fnum" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].fnr;
    }
    coaUrl += "&Slice" + (i + 1) + "=" + slices[i];
  }

  coaUrl += "&tt=" + (0,_parse_itin__WEBPACK_IMPORTED_MODULE_2__.getTripType)("OneWay", "RoundTrip", "MultiCity");
...
function print() {
  ...
  var createUrl = function(host) {
    const cur = _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.cur || "USD";
    let url = `https://${host}/api?PointOfSaleCountry=&UserCurrency=${cur}&DisplayedPrice=${
      _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.price
    }&DisplayedPriceCurrency=${cur}&UserLanguage=${_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.language ||
      "en"}&TripType=${(0,_parse_itin__WEBPACK_IMPORTED_MODULE_2__.getTripType)("OneWay", "RoundTrip", "MultiCity")}`;
    ...
    let j = 0;
    _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.forEach((itin, i) => {
      const slices = [];
...
function printEdreams(title, editions) {
  ...
  var createUrl = function(domain) {
    const deeplink = `/results/type=M;${_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.map(
        (itin, i) =>
    ...
    const segKeys = _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.map(
        (itin, i) =>
...
function printEtraveli() {
  ...
  var createUrl = function(host) {
    ...
    ggUrl +=
      _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[0].orig +
      _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[0].dest +
      convertDate(_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[0].dep, false);
    if (_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length > 1)
      ggUrl += convertDate(_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[1].dep, false);
    ggUrl += "/" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.numPax;
    ggUrl +=
      "?selectionKey=" +
      _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.map(function(itin) {
          return itin.seg
            .map(function(seg) {
              return (
                seg.carrier +
...
function printExpedia() {
  ...
  let ExpediaCreateUrl = function(expediaBase) {
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin.length; i++) {
      segUrl +=
        "&legs%5B" + i + "%5D.departureAirport=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].orig;
      segUrl +=
        "&legs%5B" + i + "%5D.arrivalAirport=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].dest;
      segUrl +=
        "&legs%5B" +
        i +
        "%5D.departureDate=" +
        _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].arr.year.toString() +
        "-" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].dep.month).slice(-2) +
        "-" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].dep.day).slice(-2);
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg.length; j++) {
        segUrl += (
          ...
          j +
          "%5D=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.year.toString() +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.month).slice(-2) +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].dep.day).slice(-2) +
        ...
        // check the min cabin:
        if (_parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].cabin < minCabin) {
          minCabin = _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.itin[i].seg[j].cabin;
        }
      }
    }
    // Build the URL:
...
(0,___WEBPACK_IMPORTED_MODULE_1__.register)("otas", printExpedia);


/***/ }),

/***/ "./src/links/otas/flightnetwork.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function printFN() {
  ...
  if (!pax) {
    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.printNotification)("Error: Failed to validate Passengers in printFN");
    return;
  }

  const createUrl = function(edition) {
    const tty = _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length === 2 ? 1 : 0;
    let search = `cref=fnbwmint&tty=${tty}&curr=${_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.cur ||
      "USD"}&nativecurr=${_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.cur || "USD"}&cls=0&adt=${
      pax.adults
    ...
    let segCount = 0;
    search += _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.map((leg, i) => {
        const key = _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length === 2 && i === 1 ? "ib" : "ob";
        const legNum = _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length > 2 ? 0 : i;
        return leg.seg
          .map((seg, j) => {
            const segNum = _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length > 2 ? segCount++ : j;
...
function formatDate(date) {
  return (
    "" +
    date.year +
    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.to2digits)(date.month) +
    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.to2digits)(date.day) +
    date.time24.replace(":", "")
  );
}

(0,___WEBPACK_IMPORTED_MODULE_0__.register)("otas", printFN);


/***/ }),

/***/ "./src/links/otas/hop2.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function print() {
  ...
  const segs = (0,_parse_itin__WEBPACK_IMPORTED_MODULE_1__.getCurrentSegs)();
  const search = `OSKDCR*${cabin}${pax.adults}${pax.children.length}${
    pax.infSeat
  }0/${_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.map(
      itin =>
        itin.orig +
        itin.dest +
...
function printLucky2go() {
  var createUrl = function(edition) {
    ...
    var url =
      ...
      edition.country +
      "&UserCurrency=" +
      (_parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.cur || "USD") +
      "&DisplayedPrice=" +
      _parse_itin__WEBPACK_IMPORTED_MODULE_2__.currentItin.price +
...
function printPriceline() {
  ...
  for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length; i++) {
    ...
    pricelineurl += "/" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].orig;
    pricelineurl += "-" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].dest;
    pricelineurl +=
      "-" +
      _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].arr.year.toString() +
      ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].dep.month).slice(-2) +
      ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].dep.day).slice(-2);
    for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg.length; j++) {
      //walks each segment of leg
      var k = 0;
      // lets have a look if we need to skip segments - Flightnumber has to be the same and it must be just a layover
      ...
      searchparam += _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].orig;
      searchparam +=
        _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.year.toString() +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.month).slice(-2) +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.day).slice(-2) +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.time.replace(":", "")).slice(-4);
      searchparam += _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].dest;
      searchparam +=
        _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].arr.year.toString() +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].arr.month).slice(-2) +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].arr.day).slice(-2) +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].arr.time.replace(":", "")).slice(
          -4
        );
      searchparam +=
        _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].bookingclass +
        _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].carrier +
        _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].fnr;
      searchparam += "~";
      j += k;
    }
  }
...
(0,___WEBPACK_IMPORTED_MODULE_1__.register)("otas", () => print("Vayama", travix, "www.vayama.com"));
(0,___WEBPACK_IMPORTED_MODULE_1__.register)("otas", () => print("BudgetAir", budgetairs, "www.budgetair.nl"));


/***/ }),

/***/ "./src/links/other/gcm.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _parse_itin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/parse/itin.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/links/index.js");
...
function printGCM() {
  ...
  for (let i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_0__.currentItin.itin.length; i++) {
    for (let j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_0__.currentItin.itin[i].seg.length; j++) {
      url += _parse_itin__WEBPACK_IMPORTED_MODULE_0__.currentItin.itin[i].seg[j].orig + "-";
      if (j + 1 < _parse_itin__WEBPACK_IMPORTED_MODULE_0__.currentItin.itin[i].seg.length) {
        if (
          _parse_itin__WEBPACK_IMPORTED_MODULE_0__.currentItin.itin[i].seg[j].dest != _parse_itin__WEBPACK_IMPORTED_MODULE_0__.currentItin.itin[i].seg[j + 1].orig
        ) {
          url += _parse_itin__WEBPACK_IMPORTED_MODULE_0__.currentItin.itin[i].seg[j].dest + ";";
        }
      } else {
        url += _parse_itin__WEBPACK_IMPORTED_MODULE_0__.currentItin.itin[i].seg[j].dest + ";";
      }
...
/***/ "./src/links/other/wheretocredit.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function printWheretocredit() {
  return {
    url:
      ...
      (0,_parse_itin__WEBPACK_IMPORTED_MODULE_0__.getCurrentSegs)()
        .map(seg =>
...
/***/ "./src/links sync recursive .[jt]s$":
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

var map = {
	"./airlines/aa.js": "./src/links/airlines/aa.js",
	"./airlines/aaSabre.js": "./src/links/airlines/aaSabre.js",
	"./airlines/ac.js": "./src/links/airlines/ac.js",
	"./airlines/af.js": "./src/links/airlines/af.js",
	"./airlines/as.js": "./src/links/airlines/as.js",
	"./airlines/az.js": "./src/links/airlines/az.js",
	"./airlines/ba.js": "./src/links/airlines/ba.js",
	"./airlines/cz.js": "./src/links/airlines/cz.js",
	"./airlines/dl.js": "./src/links/airlines/dl.js",
	"./airlines/ek.js": "./src/links/airlines/ek.js",
	"./airlines/ey.js": "./src/links/airlines/ey.js",
	"./airlines/ib.js": "./src/links/airlines/ib.js",
	"./airlines/kl.js": "./src/links/airlines/kl.js",
	"./airlines/la.js": "./src/links/airlines/la.js",
	"./airlines/lh.js": "./src/links/airlines/lh.js",
	"./airlines/lx.js": "./src/links/airlines/lx.js",
	"./airlines/oa.js": "./src/links/airlines/oa.js",
	"./airlines/os.js": "./src/links/airlines/os.js",
	"./airlines/ps.js": "./src/links/airlines/ps.js",
	"./airlines/qf.js": "./src/links/airlines/qf.js",
	"./airlines/qr.js": "./src/links/airlines/qr.js",
	"./airlines/tk.js": "./src/links/airlines/tk.js",
	"./airlines/vs.js": "./src/links/airlines/vs.js",
	"./index.js": "./src/links/index.js",
	"./meta/googleFlights": "./src/links/meta/googleFlights.js",
	"./meta/googleFlights.js": "./src/links/meta/googleFlights.js",
	"./meta/jetcost.js": "./src/links/meta/jetcost.js",
	"./meta/kayak.js": "./src/links/meta/kayak.js",
	"./meta/momondo.js": "./src/links/meta/momondo.js",
	"./meta/skyscanner.js": "./src/links/meta/skyscanner.js",
	"./meta/tripadvisor.js": "./src/links/meta/tripadvisor.js",
	"./otas/cheapoair.js": "./src/links/otas/cheapoair.js",
	"./otas/edestinos.js": "./src/links/otas/edestinos.js",
	"./otas/edreams.js": "./src/links/otas/edreams.js",
	"./otas/etraveli.js": "./src/links/otas/etraveli.js",
	"./otas/expedia.js": "./src/links/otas/expedia.js",
	"./otas/flightnetwork.js": "./src/links/otas/flightnetwork.js",
	"./otas/hop2.js": "./src/links/otas/hop2.js",
	"./otas/lucky2go.js": "./src/links/otas/lucky2go.js",
	"./otas/priceline.js": "./src/links/otas/priceline.js",
	"./otas/travix.js": "./src/links/otas/travix.js",
	"./other/gcm.js": "./src/links/other/gcm.js",
	"./other/wheretocredit.js": "./src/links/other/wheretocredit.js"
};
...
webpackContext.id = "./src/links sync recursive .[jt]s$";
...
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/utils.js");
...
function readItinerary() {
  ...
  var legs = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.exRE)(html, re);
  ...
  var bfs = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.exRE)(html, re);
  var bf = { c: "", f: "", l: new Array() };
  for (i = 0; i < bfs.length; i += 3) {
    bf.c = bfs[i];
    bf.f = bfs[i + 1];
    farebases.push(bf.f);
    bf.l = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.exRE)(bfs[i + 2], /(\w\w\w\-\w\w\w)/g);
  ...
  segs = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.exRE)(html, re);
  ...
  for (i = 0; i < segs.length; i += 15) {
    ...
    const month = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.monthnameToNumber)(segs[i + 3]);
  ...
  for (var i = 0; i < dirtyFare.length; i++) {
    ...
    if (curfare.length > 1) {
      ...
      if (l == 0) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_0__.printNotification)("Unused fare:" + dirtyFare[i]);
      }
    }
  }
  ...
  milepaxprice = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.exRE)(html, re);
  // detect currency
...
function parseAddInfo(info) {
  ...
  temp = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.exRE)(info, re);
  if (temp.length == 2) {
    // Got datechange
    const month = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.monthnameToNumber)(temp[0]);
...
function getAmadeusUrl(config) {
  ...
  for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin.length; i++) {
    ...
    lastcabin = _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[0].cabin;
    // walks each leg
    for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg.length; j++) {
      //walks each segment of leg
      var k = 0;
      ...
      if (
        curseg > 3 ||
        (_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].cabin != lastcabin && config.sepcabin == 1)
      ) {
        if (lastdest != "") {
          //close prior flight
        ...
        curseg = 1;
        curleg++;
        url += "&B_LOCATION_" + curleg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].orig;
        ...
        url +=
          ...
          (config.inctimes == 1
            ? (
                "0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].dep.time.replace(":", "")
              ).slice(-4)
            : "0000");
        url +=
          "&CABIN_" + curleg + "=" + cabins[_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].cabin];
        url += "&ALLOW_ALTERNATE_AVAILABILITY_" + curleg + "=FALSE";
        url += "&DATE_RANGE_VALUE_" + curleg + "=0";
      }
      lastarrtime =
        _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].arr.year +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].arr.month).slice(-2) +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].arr.day).slice(-2) +
        (config.inctimes == 1
          ? (
              "0" + _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].arr.time.replace(":", "")
            ).slice(-4)
          : "0000");
      if (config.detailed === 1) {
        ...
        url +=
          ...
          curseg +
          "=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].dest;
        url +=
          "&E_LOCATION_CITY_" +
          curleg +
          "_" +
      ...
      url +=
        ...
        curseg +
        "=" +
        _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].farebase;
      lastdest = _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j + k].dest;
      lastcabin = _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].cabin;
      if (_parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].cabin > maxcabin)
        maxcabin = _parse_itin__WEBPACK_IMPORTED_MODULE_1__.currentItin.itin[i].seg[j].cabin;
      j += k;
    }
  }
...
function getAmadeusTriptype() {
  return (0,_parse_itin__WEBPACK_IMPORTED_MODULE_1__.getTripType)("O", "R", "M");
}
// **** END AMADEUS ****
...
__webpack_require__("./src/links/index.js");
...
function printLinksContainer() {
  ...
  if ((0,_utils__WEBPACK_IMPORTED_MODULE_3__.findtargets)("editoritem").length > 0) {
    return;
  }
  ...
  //  S&D powertool items
  const elems = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.findtargets)("powertoolsitem");
  ...
  groups.forEach((group, i) => {
    ...
    groupLinks.forEach(link => {
      ...
      if (link.img) {
        printImage(link);
      } else if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.enableInlineMode == 1) {
        printUrlInline(link);
      } else {
        printUrl(link);
      }
    ...
    _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.enableDeviders == 1 &&
      links[group].length &&
      i != groups.length - 1 &&
      printSeperator();
  });
...
function bindLinkClicks() {
  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.enableAffiliates == 1) {
...
function printImage(link) {
  ...
  const item =
    ...
    "/>" +
    (link.url ? "</a>" : "");
  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.enableIMGautoload == 1) {
    container && container.insertAdjacentHTML("beforeend", item);
  } else {
...
function getSidebarContainer() {
  return (
    ...
    (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.enableInlineMode == 1
...
function createUrlContainerInline() {
  const target = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.findtarget)(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__.default.resultpage.mcDiv, 1);
  if (!target) return;

  const newdiv = document.createElement("div");
  newdiv.classList.add(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__.default.resultpage.mcDiv);
  newdiv.classList.add(`powertoolslinkinlinecontainer`);
  newdiv.innerHTML =
    '<div class="' +
    _settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__.default.resultpage.mcHeader +
    '">Powertools</div><ul id="powertoolslinkcontainer" class="' +
    _settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__.default.resultpage.mcLinkList +
    '"></ul>';
...
function printLink(link) {
  let html = `<div><label style="font-size:${Number(
    _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.linkFontsize
  )}%;font-weight:600">
    <a href="${link.url}" target=${link.target || "_blank"}>${(_settings_translations__WEBPACK_IMPORTED_MODULE_2__.default[
    _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.language
  ] &&
    _settings_translations__WEBPACK_IMPORTED_MODULE_2__.default[_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.language]["use"]) ||
    "Use "} ${link.title}</a>
  </label>`;
...
function createUrlContainer() {
  const target = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.findtarget)(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__.default.resultpage.milagecontainer, 1);
  if (!target) return;
...
function printSeperator() {
  ...
  container &&
    container.insertAdjacentHTML(
      "beforeend",
      _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__.default.enableInlineMode
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _appSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/settings/appSettings.ts");
...
var itaSettings = __webpack_require__("./src/settings/itaSettings.js");
// EXTERNAL MODULE: ./src/utils.js
var utils = __webpack_require__("./src/utils.js");
// EXTERNAL MODULE: ./src/parse/itin.js
var parse_itin = __webpack_require__("./src/parse/itin.js");
// EXTERNAL MODULE: ./src/print/index.ts
var print = __webpack_require__("./src/print/index.ts");
// EXTERNAL MODULE: ./src/print/settings.ts
var settings = __webpack_require__("./src/print/settings.ts");
...
// EXTERNAL MODULE: ./src/state/index.ts + 1 modules
var state = __webpack_require__("./src/state/index.ts");
// EXTERNAL MODULE: ./src/print/history.tsx + 17 modules
var print_history = __webpack_require__("./src/print/history.tsx");
